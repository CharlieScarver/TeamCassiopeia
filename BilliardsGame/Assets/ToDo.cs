...
// + добавено в началното меню режим на тренировка и при избор се 
// 		преминава в този режим
...
// ! подобрена физиката на играта:
// 		! движенията на топките да затихват по-бързо
//		! топките да се разпръзкват по обичайният за билярдна игра 
//			начин, когато първоначално се разбиват
// + добавено когато бялата топка достигне един от колайдърите 
//		в дупките да се появи в точно определена позиция на масата и
//		потребителят посредством клавиши може да я мести и след това 
//		може да я фиксира при натискане клавиша Enter
// + добавено когато друга топка достигне един такъв колайдер, тя става 
//		неактивна
// ! топките спират под минимална скорост
// ! изчистен бъга с това, че бялата топка и другите топки трудно падат 
//		в дупките
// + добавена сцена за приключена игра. От сцената може да се 
//		избере режим на тренировка, режим на игра от 2 играчи
//		и изход
// + направен режим на тренировка в който когато черната топка 
//		влезе в дупка (независимо дали има останали топки) се 
//		отива в сцена за приключена игра


// Да се направи:
//
// - да се добави анимация на щеката по времето на натискане и 
...
//			като функция и да се вика от 1 място както за режим с ce1 играч, 
